...
--
-- Hôte : 127.0.0.1
-- Généré le : jeu. 15 fév. 2024 à 19:47
...
CREATE TABLE `ajouter` (
  ...
  `jours_travailler` varchar(50) NOT NULL,
  `date_entree_employer` date NOT NULL,
  `date_sortie_employer` date DEFAULT NULL,
  `date_jours_vacances` date DEFAULT NULL,
  `date_fin_vacances` date DEFAULT NULL,
...
INSERT INTO `ajouter` (`id_ajouter_configuration`, `jours_travailler`, `date_entree_employer`, `date_sortie_employer`, `date_jours_vacances`, `date_fin_vacances`, `siret`, `id_employer`, `droit_utilisateur`, `debut_repas`, `fin_repas`) VALUES
(1, '[\"lundi\",\"mardi\",\"mercredi\",\"jeudi\",\"vendredi\"]', '2024-01-27', NULL, NULL, NULL, '12341564897897', 11, NULL, NULL, NULL),
(2, '[\"lundi\",\"mardi\"]', '2024-02-04', NULL, NULL, NULL, '12345678912345', 13, NULL, NULL, NULL),
(3, '[\"lundi\",\"vendredi\"]', '2024-02-04', NULL, NULL, NULL, '12345678912345', 14, NULL, NULL, NULL);
...
CREATE TABLE `animal` (
  ...
  `prenom_animal` varchar(50) NOT NULL,
  `date_naissance_animal` date NOT NULL,
  `date_creation_animal` date DEFAULT NULL,
  `date_fin_animal` date DEFAULT NULL,
...
INSERT INTO `animal` (`id_animal`, `prenom_animal`, `date_naissance_animal`, `date_creation_animal`, `date_fin_animal`, `id_race`, `id_patient`) VALUES
(6, 'titi', '2023-06-05', '2024-02-05', '2024-02-01', 8, 211),
(7, 'popo', '2015-05-06', '2024-02-05', NULL, 560, 211),
(8, 'spirit2', '2024-05-02', '2024-02-10', NULL, 445, 211),
(9, 'rere', '2024-05-02', '2024-02-10', NULL, 505, 109),
(12, 'titi', '2024-05-02', '2024-02-10', NULL, 3, 211);
...
INSERT INTO `employer` (`id_employer`, `nom`, `prenom`, `adresse`, `complement_adresse`, `code_postal`, `ville`, `telephone`, `email`, `profession`, `password`, `images`, `date_creation`) VALUES
(11, 'regnier', 'sylvain', 'AVENUE DU MARECHAL NEY, BÂT C6BÂT C6', '', '13011', 'MARSEILLE', '0620941745', 'regnier.lena44@yahoo.fr', 'Choisissez...', '1234', NULL, '2024-01-27'),
(13, 'vh', 'xg', '6 avenue du marechal ney', '', '13011', 'marseille', '0620941742', 'toto@gmail.com', 'Vétérinaire', '1234', NULL, '2024-02-04'),
(14, 'dfhgh', 'sdfgjk', 'dtfygh', 'cfgbj', '13011', 'marseille', '0101010101', 'dttgh@gmail.com', 'Toiletteur', '', './Content/img/utilisateur/', '2024-02-04');
...
INSERT INTO `patient` (`id_patient`, `nom`, `prenom`, `adresse`, `complement_adresse`, `code_postal`, `ville`, `telephone`, `mdp`, `email`, `date_creation`, `date_fin`, `droit_utilisateur`) VALUES
(109, 'regnier', 'sylvain', 'AVENUE DU MARECHAL NEY, BÂT C6BÂT C6', '', '13011', 'MARSEILLE', '0620941745', '1234', 'regnier.lena44@yahoo.fr', '2024-01-21', NULL, 'Patient'),
(211, 'thierry', 'thierry', '6 rue judaïque', '', '33000', 'bordeaux', '0101010101', '1234', 'thierry.leng@gmail.com', '2024-01-23', NULL, 'Patient'),
(216, 'sisi', 'reg', '6 avenue daumesnil', '', '75012', 'paris', '0101010101', '1234', 'sisi@gmail.com', '2024-02-04', NULL, 'Patient'),
(217, '', '', '', '', '', '', '', '', '', '2024-02-04', NULL, 'Patient'),
(218, 'erty', 'sdfyg', '5 rue nationale', '', '59000', 'lille', '0101010101', '1234', 'azer@yahoo.fr', '2024-02-04', NULL, 'Patient'),
(219, 'wxc', 'wxc', '6 rurouz', '', '22310', 'plufur', '0101010101', '1234', 'wx@yahoo.fr', '2024-02-04', NULL, 'Patient'),
(220, 'wxc', 'wxc', '6 rurouz', '', '22310', 'plufur', '0101010101', '1234', 'wx1@yahoo.fr', '2024-02-04', NULL, 'Patient'),
(221, 'wxc', 'wxc', '6 rurouz', '', '22310', 'plufur', '0101010101', '1234', 'wx12@yahoo.fr', '2024-02-04', NULL, 'Patient'),
(222, 'wxc', 'wxc', '6 rurouz', '', '22310', 'plufur', '0101010101', '1234', 'wx121@yahoo.fr', '2024-02-04', NULL, 'Patient');
...
INSERT INTO `rdv` (`id_rdv`, `date_rdv`, `heure`, `status`, `id_employer`, `id_patient`, `siret`) VALUES
(1, '2024-02-14', '11:00:00', '', 11, 211, '12341564897897');
...
INSERT INTO `societe` (`siret`, `nom_societe`, `profession`, `nom_dirigeant`, `adresse`, `complement_adresse`, `code_postal`, `ville`, `telephone_societe`, `telephone_dirigeant`, `email`, `password`, `images`, `date_creation`, `date_resiliation`, `date_validation`, `status`, `droit_utilisateur`) VALUES
...
('12345678912345', 'toto', 'vétérinaire', 'reg', '6 avenue du', '', '13011', 'marseille', '0606060606', '0606060606', 'toto@gmail.com', '1234', './Content/img/utilisateur/65be3b2ecb95c3.38179074.png', '2024-02-03', NULL, NULL, 'Valider', 'Admin');
...
ALTER TABLE `animal`
  ...
  ADD KEY `date_naissance` (`date_naissance_animal`),
  ADD KEY `id_patient` (`id_patient`),
  ADD KEY `id_race` (`id_race`) USING BTREE,
  ADD KEY `date_creation` (`date_creation_animal`) USING BTREE,
  ADD KEY `date_fin` (`date_fin_animal`) USING BTREE;
...
ALTER TABLE `employer`
  ...
  ADD KEY `images` (`images`) USING BTREE;
...
--
ALTER TABLE `ajouter`
  MODIFY `id_ajouter_configuration` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `employer`
  MODIFY `id_employer` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT pour la table `patient`
--
ALTER TABLE `patient`
  MODIFY `id_patient` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=223;
...
ALTER TABLE `animal`
  ...
  ADD CONSTRAINT `animal_ibfk_3` FOREIGN KEY (`id_patient`) REFERENCES `patient` (`id_patient`);
...
ALTER TABLE `soigner`
  ...
  ADD CONSTRAINT `soigner_ibfk_3` FOREIGN KEY (`id_employer`) REFERENCES `employer` (`id_employer`);
COMMIT;
