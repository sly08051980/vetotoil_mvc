    ...
    <div class="row d-flex justify-content-center align-items-center pt-5">
        ...
        <div class="card mb-3" style="max-width: 540px;">
            <div class="row g-0">
                ...
                <div class="col-md-8">
                    <div class="card-body">
                        <h5 class="card-title"><?= isset($_SESSION['nom']) ? htmlspecialchars($_SESSION['nom']) : '' ?> <?= isset($_SESSION['prenom']) ? htmlspecialchars($_SESSION['prenom']) : '' ?></h5>
                        <p class="card-text">Adresse : <?= isset($_SESSION["adresse"]) ? htmlspecialchars($_SESSION["adresse"]) : '' ?></p>
                        <p class="card-text">Code postal : <?= isset($_SESSION['code_postal']) ? htmlspecialchars($_SESSION['code_postal']) : '' ?></p>
                        <p class="card-text">Ville : <?= isset($_SESSION["ville"]) ? htmlspecialchars($_SESSION["ville"]) : '' ?></p>
                        ...
                        <div class="row" id="descriptionAnimal">
                            <form action="?controller=animal&action=enregistrer_animal" method="POST">
                                <div class="mb-3">
                                    ...
                                    <input type="hidden" class="form-control" id="patient" name="patient" value="<?= isset($_SESSION["id"]) ? $_SESSION["id"] : '' ?>">
