    ...
    <div class="row ">
        ...
        <p><b>Client :</b> tout professionnel ou personne physique capable au sens des articles 1123 et suivants du Code
            ...
            <b>Prestations et Services :</b> <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> met à disposition des Clients
            :
        </p>
        ...
        <p><b>Informations clients :</b> Ci après dénommé « Information (s) » qui correspondent à l’ensemble des données
            personnelles susceptibles d’être détenues par <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> pour la gestion de votre
        ...
        <h3 class="mt-4">1. Présentation du site internet.</h3>
        <p>En vertu de l'article 6 de la loi n° 2004-575 du 21 juin 2004 pour la confiance dans l'économie numérique, il
            est précisé aux utilisateurs du site internet <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> l'identité des différents
            intervenants dans le cadre de sa réalisation et de son suivi:
        </p>
        <p><strong>Propriétaire</strong> : regnier – 6 avenue Marechal Ney 13011 Marseille<br>

            <strong>Responsable publication</strong> : Regnier – regnier.sylvain.afpa@gmail.com<br>
            Le responsable publication est une personne physique ou une personne morale.<br>
            <strong>Webmaster</strong> : Regnier – regnier.sylvain.afpa@gmail.com<br>
            <strong>Hébergeur</strong> : Interne – 6 avenue Marechal Ney 13011 Marseille 0620941745<br>
            <strong>Délégué à la protection des données</strong> : Regnier – regnier.sylvain.afpa@gmail.com<br>
        </p>
        ...
        <h3 class="mt-4">2. Conditions générales d’utilisation du site et des services proposés.</h3>
        ...
        <p>L’utilisation du site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>
            ...
            site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> sont donc invités à les
        ...
        <p>Ce site internet est normalement accessible à tout moment aux utilisateurs. Une interruption pour raison de
            maintenance technique peut être toutefois décidée par <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>, qui s’efforcera alors de
            communiquer préalablement aux utilisateurs les dates et heures de l’intervention.
            Le site web <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est mis à jour
            régulièrement par <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>
            ...
            connaissance.</p>
        <h3 class="mt-4">3. Description des services fournis.</h3>
        <p>Le site internet <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> a pour objet
            de fournir une information concernant l’ensemble des activités de la société.
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> s’efforce de fournir sur le
            site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> des informations aussi
        ...
        <p>Toutes les informations indiquées sur le site <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> sont données à titre
            indicatif, et sont susceptibles d’évoluer. Par ailleurs, les renseignements figurant sur le site <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ne sont pas exhaustifs. Ils
            sont donnés sous réserve de modifications ayant été apportées depuis leur mise en ligne.</p>

        <h3 class="mt-4">4. Limitations contractuelles sur les données techniques.</h3>
        <p>Le site utilise la technologie JavaScript.
            ...
            Le site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est hébergé chez un
        ...
        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> et l’hébergeur ne pourront
            être tenus responsables en cas de dysfonctionnement du réseau Internet, des lignes téléphoniques ou du
            matériel informatique et de téléphonie lié notamment à l’encombrement du réseau empêchant l’accès au
            serveur.</p>

        <h3 class="mt-4">5. Propriété intellectuelle et contrefaçons.</h3>
        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est propriétaire des droits
            ...
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>.</p>
        ...
        <h3 class="mt-4">6. Limitations de responsabilité.</h3>
        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> agit en tant qu’éditeur du
            site. <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est responsable de la
            qualité et de la véracité du Contenu qu’il publie. </p>

        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ne pourra être tenu
            responsable des dommages directs et indirects causés au matériel de l’utilisateur, lors de l’accès au site
            internet <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>, et résultant soit
        ...
        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ne pourra également être tenu
            ...
            consécutifs à l’utilisation du site <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>.
            Des espaces interactifs (possibilité de poser des questions dans l’espace contact) sont à la disposition des
            utilisateurs. <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> se réserve le
            ...
            données. Le cas échéant, <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> se
        ...
        <h3 class="mt-4">7. Gestion des données personnelles.</h3>
        ...
        <h4 class="mt-4">7.1 Responsables de la collecte des données personnelles</h4>
        <p>Pour les Données Personnelles collectées dans le cadre de la création du compte personnel de l’Utilisateur et
            de sa navigation sur le Site, le responsable du traitement des Données Personnelles est : regnier. <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>est représenté par Regnier,
            son représentant légal</p>

        <p>En tant que responsable du traitement des données qu’il collecte, <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> s’engage à respecter le
            cadre des dispositions légales en vigueur. Il lui appartient notamment au Client d’établir les finalités de
            ses traitements de données, de fournir à ses prospects et clients, à partir de la collecte de leurs
            ...
            Chaque fois que <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> traite des
            Données Personnelles, <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> prend
            ...
            au regard des finalités pour lesquelles <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> les traite.</p>

        <h4 class="mt-4">7.2 Finalité des données collectées</h4>
        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est susceptible de traiter
        ...
        <ul>
            ...
            <li>pour mener des enquêtes de satisfaction facultatives sur <a
                    href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> : adresse email </li>
            <li>pour mener des campagnes de communication (sms, mail) : numéro de téléphone, adresse email</li>


        </ul>

        <p><a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ne commercialise pas vos
            données personnelles qui sont donc uniquement utilisées par nécessité ou à des fins statistiques et
            d’analyses.</p>

        <h4 class="mt-4">7.3 Droit d’accès, de rectification et d’opposition</h4>

        <p>
            Conformément à la réglementation européenne en vigueur, les Utilisateurs de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> disposent des droits
            suivants : </p>
        <ul>
            ...
            <li>droit de définir le sort des données des Utilisateurs après leur mort et de choisir à qui <a
                    href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> devra communiquer (ou
                non) ses données à un tiers qu’ils aura préalablement désigné</li>
        </ul>

        <p>Dès que <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> a connaissance du
            décès d’un Utilisateur et à défaut d’instructions de sa part, <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> s’engage à détruire ses
        ...
        <p>Si l’Utilisateur souhaite savoir comment <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> utilise ses Données
            Personnelles, demander à les rectifier ou s’oppose à leur traitement, l’Utilisateur peut contacter <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> par écrit à l’adresse
            suivante : </p>

        regnier – DPO, Regnier <br>
        6 avenue Marechal Ney 13011 Marseille.

        <p>Dans ce cas, l’Utilisateur doit indiquer les Données Personnelles qu’il souhaiterait que <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> corrige, mette à jour ou
        ...
        <p>
            Les demandes de suppression de Données Personnelles seront soumises aux obligations qui sont imposées à <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> par la loi, notamment en
            matière de conservation ou d’archivage des documents. Enfin, les Utilisateurs de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> peuvent déposer une
            réclamation auprès des autorités de contrôle, et notamment de la CNIL (https://www.cnil.fr/fr/plaintes).</p>
        <h4 class="mt-4">7.4 Non-communication des données personnelles</h4>
        <p>
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> s’interdit de traiter,
            ...
            client. Pour autant, <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> reste
        ...
        <p>
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> s’engage à prendre toutes
            les précautions nécessaires afin de préserver la sécurité des Informations et notamment qu’elles ne soient
            ...
            confidentialité des Informations du Client est portée à la connaissance de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>, celle-ci devra dans les
            meilleurs délais informer le Client et lui communiquer les mesures de corrections prises. Par ailleurs <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ne collecte aucune «
            données sensibles ».
        </p>

        <p>
            Les Données Personnelles de l’Utilisateur peuvent être traitées par des filiales de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> et des sous-traitants
        ...
        <p>
            ...
            personnes susceptibles d’avoir accès aux données des Utilisateurs de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> sont principalement les
            agents de notre service client.</p>

        <div ng-bind-html="rgpdHTML"></div>

        <h3 class="mt-4">8. Notification d’incident</h3>
        <p>
        ...
        <p>
            Aucune information personnelle de l'utilisateur du site <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> n'est publiée à l'insu de
            l'utilisateur, échangée, transférée, cédée ou vendue sur un support quelconque à des tiers. Seule
            l'hypothèse du rachat de <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> et
            de ses droits permettrait la transmission des dites informations à l'éventuel acquéreur qui serait à son
            tour tenu de la même obligation de conservation et de modification des données vis à vis de l'utilisateur du
            site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>.</p>
        ...
        <p>
            ...
            Santé, <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> utilise des réseaux
            protégés par des dispositifs standards tels que par pare-feu, la pseudonymisation, l’encryption et mot de
            passe. </p>

        <p>
            Lors du traitement des Données Personnelles, <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>prend toutes les mesures
        ...
        <h3 class="mt-4">9. Liens hypertextes « cookies » et balises (“tags”) internet</h3>
        <p>
            Le site <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> contient un certain
            nombre de liens hypertextes vers d’autres sites, mis en place avec l’autorisation de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>. Cependant, <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> n’a pas la possibilité de
        ...
        <p>
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est susceptible de traiter
            les informations de l’Utilisateur concernant sa visite du Site, telles que les pages consultées, les
            recherches effectuées. Ces informations permettent à <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> d’améliorer le contenu du
        ...
        <p>
            ...
            avant qu’un Cookie soit susceptible d’être enregistré dans son terminal. <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> informe l’Utilisateur que,
        ...
        <p>
            ...
            Site peuvent être limitées. Cela pourrait également être le cas lorsque <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ou l’un de ses prestataires
            ...
            Internet.</p>
        <p>
            Le cas échéant, <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> décline
            toute responsabilité pour les conséquences liées au fonctionnement dégradé du Site et des services
            éventuellement proposés par <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>,
            résultant (i) du refus de Cookies par l’Utilisateur (ii) de l’impossibilité pour <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> d’enregistrer ou de
            consulter les Cookies nécessaires à leur fonctionnement du fait du choix de l’Utilisateur. Pour la gestion
            des Cookies et des choix de l’Utilisateur, la configuration de chaque navigateur est différente. Elle est
        ...
        <p>
            ...
            Cookies. <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> pourra en outre
        ...
        <p>
            ...
            figurant sur le Site de <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> ou
            dans son application mobile et si l’Utilisateur a accepté le dépôt de cookies en poursuivant sa navigation
            sur le Site Internet ou l’application mobile de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>, Twitter, Facebook,
            Linkedin et Google Plus peuvent également déposer des cookies sur vos terminaux (ordinateur, tablette,
        ...
        <p>
            ...
            votre navigation sur le Site Internet ou l’application mobile de <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>. À tout moment,
            l’Utilisateur peut néanmoins revenir sur son consentement à ce que <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> dépose ce type de cookies.
        </p>

        <h4 class="mt-4">Article 9.2. BALISES (“TAGS”) INTERNET</h4>

        <p>

            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> peut employer
            occasionnellement des balises Internet (également appelées « tags », ou balises d’action, GIF à un pixel,
            GIF transparents, GIF invisibles et GIF un à un) et les déployer par l’intermédiaire d’un partenaire
        ...
        <p>
            Cette technologie permet à <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>
            d’évaluer les réponses des visiteurs face au Site et l’efficacité de ses actions (par exemple, le nombre de
            fois où une page est ouverte et les informations consultées), ainsi que l’utilisation de ce Site par
            l’Utilisateur. </p>
        <p>
            ...
            <a href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a>, et fournir d’autres
            services relatifs à l’utilisation de celui-ci et d’Internet.</p>
        <p>
        </p>
        <h3 class="mt-4">10. Droit applicable et attribution de juridiction.</h3>
        <p>
            Tout litige en relation avec l’utilisation du site <a
                href="http://127.0.0.1:5500/index.php">http://127.0.0.1:5500/index.php</a> est soumis au droit
            français.
            En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux
            compétents de Marseille</p>
