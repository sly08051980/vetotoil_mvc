<div class="container" id="inscriptionPro">
    ...
    <div class="row justify-content-center">
        <form class="col-lg-12" method="POST" action="?controller=pro&action=inscription_pro" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="nomDirigeant" id="nomDirigeant" aria-describedby="nomDirigeant">
                        <ul id="list"></ul></label>
                    </div>
                ...
                <div class="col-lg-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="complementAdresse" id="complementAdresse" aria-describedby="complementAdresse">
                    </div>
                    <div class="mb-3">
                ...
                <div class="col-lg-4">
                    <div class="mb-3">
                        ...
                        <input type="tel" class="form-control" name="telephoneSociete" id="telephoneSociete" aria-describedby="telephoneSociete" pattern="[0-9]{10}">
                    </div>
                    <div class="mb-3">
                        <label for="telephoneDirigeant" class="form-label">Téléphone Dirigeant</label>
                        <input type="tel" class="form-control" name="telephoneDirigeant" id="telephoneDirigeant" aria-describedby="telephoneDirigeant" pattern="[0-9]{10}">
                    </div>
                    <div class="mb-3">
